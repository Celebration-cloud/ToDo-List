 ...
 function handleSearch(e){
  ...
  setSearch(e.target.value);
   const result = data.filter(
    (item) => search.length > 0 ? results.toLowerCase().includes(item.Title.toLowerCase()) : item
  );
  setData(result);
  ...
  return (
    <div className={styles.content}>
      ...
      <div className={styles.group}>
        ...
        <input onChange={handleSearch} className={styles.input} type="search" placeholder="Search" />
      </div>
